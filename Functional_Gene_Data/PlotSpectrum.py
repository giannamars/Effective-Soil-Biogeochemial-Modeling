...
import string
xlabels = ['%s' % n for n in  numpy.append(scipy.arange(59,23,-1), [37,36])]
#xlabels=[]
...
Jvals = numpy.array([7.66, 7.66, 7.62, 7.48, 7.39, 7.14, 7.27, 7.29, 7.08, 6.99, 7.38, 7.68, 6.88, 6.87, 
                  7.06, 6.89, 7.36, 7.05, 6.97, 6.92, 7.36, 7.34, 7.21, 7.15, 7.11, 7.08, 7.27, 7.25,
                  7.28, 7.30, 6.75, 6.61, 6.70,16.66])
nums = numpy.arange(60)
pnums = nums[60:25:-1] 
...
f.savefig('reductionspectraplot.svg',dpi=dpi, transparent=True)
pylab.show()
