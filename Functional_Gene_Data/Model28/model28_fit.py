...
model_net = IO.from_SBML_file('PECCAT28.xml', 'base')
...
IO.eqns_TeX_file(model_net, 'model28.tex')

## Create the model
m = Model([PECCAT_experiment.expt], [model_net])
p0= m.get_params().copy()

p28 = Utility.load('p27.geodesics.bpkl')
#
p28 = np.delete(p28,28)
p28 = np.delete(p28,27)
p28 = np.delete(p28,25)
p28 = np.delete(p28,2)
...
Utility.save(popt, 'popt28.model.bpkl')
