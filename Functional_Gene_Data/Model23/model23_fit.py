...
model_net = IO.from_SBML_file('PECCAT23.xml', 'base')
...
IO.eqns_TeX_file(model_net, 'model23.tex')

## Create the model
m = Model([PECCAT_experiment.expt], [model_net])
p0= m.get_params().copy()

p23 = Utility.load('popt22.model.bpkl')
p23[4]= 1e-3
...
Utility.save(popt, 'popt23.model.bpkl')
