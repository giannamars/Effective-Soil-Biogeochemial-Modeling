...
import string
xlabels = ['%s' % n for n in  numpy.append(scipy.arange(27,20,-1), [37,36])]
#xlabels=[]
...
Jvals = numpy.array([4.32, 3.83, 3.60, 3.59, 3.90, 3.70, 8.05])
nums = numpy.arange(28)
pnums = nums[28:20:-1] 
...
f.savefig('reductionspectraplot1.svg',dpi=dpi, transparent=True)
pylab.show()
