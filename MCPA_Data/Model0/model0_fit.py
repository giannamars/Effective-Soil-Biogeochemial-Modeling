...
model_net = IO.from_SBML_file('PECCAT00.xml', 'base')
...
p0 = Utility.load('popt001.model.bpkl')
...
Utility.save(popt, 'popt001.model.bpkl')
...
#Utility.save(ens_data, 'model00.ens_data.bpkl')
#costs = np.array(costs)
#Utility.save(costs, 'model00.costs.bpkl')
