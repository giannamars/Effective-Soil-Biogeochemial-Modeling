...
fig.subplots_adjust(left=.18, bottom=.17, right=.99, top=.85)

labels = ['Y', r'$\vartheta_1$', r'$k_B$']
colors = ['#cccccc', '#969696', '#636363']
...
fig.savefig('German_Limit_1.png', dpi=300)
...
e0 = np.loadtxt(os.path.join('../Model0', 'hessian_limit0.dat'))

l = Plotting.plot_eigval_spectrum(e0, offset=0.15, ax=ax, widths=0.7, lw=1.0)
l = Plotting.plot_eigval_spectrum(e, offset = 0.15+1, widths=0.7, lw=1, ax=ax)
ax.set_ylim(1e-3, 1e7)
ax.set_xticks(0.5 + scipy.arange(2))
xlabels = ['4', '3']
ax.set_xticklabels(xlabels, fontsize=10)
ax.set_ylabel('Hessian eigenvalues')
ax.set_xlabel('Number of parameters')

plt.savefig('German_eigenvalues.png', dpi=300)
